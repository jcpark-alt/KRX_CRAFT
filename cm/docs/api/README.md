...
- **참조 파일 경로:** `D:\workspace\W_Craft_gcc_20260529\cm\docs\api\mgt\mgt_function_analysis_report.md`
...
- **연동 타겟 주소:** `D:\workspace\W_Craft_gcc_20260529\cm\docs\api\gcc\index.html`
...
- 연동 타겟: /cm/docs/api/gcc/index.html
