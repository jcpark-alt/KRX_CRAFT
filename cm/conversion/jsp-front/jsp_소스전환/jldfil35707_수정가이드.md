# jldfil35707 수정 가이드 — editor-web generate 산출물 후속 정비

> 원본: `../krx_소스전환/jldfil35707.xml` → 정비본: `jsp-front/jldfil35707.xml` (2026-09-07)
...
증권시장 ETF/ETN/상장형 수익증권 상장수수료 계산원칙 안내 팝업. 상장할 금액(신탁원본액·발행원본액) 구간별 수수료율(1/3 적용)과 상장심사수수료·입금계좌 안내가 전부 정적 마크업이며, 스크립트는 파라미터 수신(init_recvParam)과 [닫기](btn_self) 팝업 종료만 수행한다.
