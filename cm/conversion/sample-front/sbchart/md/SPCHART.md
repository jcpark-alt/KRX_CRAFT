...
| 항목 | 내용 |
|------|------|
| 대상 화면 | `cm/conversion/sample-front/sbchart/CANDLESTICK/SPCHART_CANDLESTICK.xml` (원 문의 화면: ULDCOM91000) |
...
> - SBChart 자주 쓰는 속성·기능의 일반 정의는 **[SBCHART_OPTIONS.md](SBCHART_OPTIONS.md)** 참고.
