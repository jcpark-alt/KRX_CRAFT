...
- **왼쪽 사이드바 (Sidebar Area):** - `/cm/gcc` 아래의 파일 목록을 트리 또는 리스트 형태로 나열.
...
D:\workspace\W_Craft_gcc_20260529\cm\gcc 폴더에 각 파일 별로 전체 소스가 있으니 실제 파일을 참고해서 구조를 잡아줘.
...
## 5. API 문서 생성 위치
D:\workspace\W_Craft_gcc_20260529\cm\docs\api 폴더 아래에 신규 폴더에 생성해줘.
예) D:\workspace\W_Craft_gcc_20260529\cm\docs\api\gcc
