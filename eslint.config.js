...
module.exports = [
  {
    ...
    // cm/cert/**: 백엔드 정적 폴더(/resources/**) 사본 — 이니텍·라온 벤더 JS, jQuery, 부트스트랩, 정적 HTML 샘플. lint 대상 아님
    ignores: ["node_modules/**", "coverage/**", "tools/wsxml_lint/**", "cm/cert/**", "websquare/**", "cm/conversion/sample-front/**"],
  },
  {
    files: ["**/*.js"],
    languageOptions: {
